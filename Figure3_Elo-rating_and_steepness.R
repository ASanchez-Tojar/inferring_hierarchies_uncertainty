...
# affects the performance of the hierarchy method, Figure 4 from: 
...
# 
# # write.csv(db,
# #           "databases_package/final_data_for_Figures_backup/Fig4_elo_no_rand_parameter_space_100sim_fixed_biases_10ind.csv",row.names=FALSE)
# 
# # write.csv(db,
# #           "databases_package/final_data_for_Figures_backup/Fig4_elo_no_rand_parameter_space_100sim_fixed_biases_50ind.csv",row.names=FALSE)
# 
# write.csv(db,
#           "databases_package/final_data_for_Figures_backup/Fig4_elo_no_rand_parameter_space_100sim_fixed_biases_25ind_100int.csv",row.names=FALSE)
# 
...
# eloparameterspace <- read.table("databases_package/final_data_for_Figures_backup/Fig4_elo_no_rand_parameter_space_100sim_fixed_biases_10ind.csv",
#                                 header=TRUE,sep=",")

# eloparameterspace <- read.table("databases_package/final_data_for_Figures_backup/Fig4_elo_no_rand_parameter_space_100sim_fixed_biases_50ind.csv",
#                                 header=TRUE,sep=",")

eloparameterspace <- read.table("databases_package/final_data_for_Figures_backup/Fig4_elo_no_rand_parameter_space_100sim_fixed_biases_25ind_100int.csv",
                                header=TRUE,sep=",")
...
tiff("plots/after_revision/Figure4_Elo-rating_and_steepness_100int_25ind_Poisson.tiff", 
