...
tiff("plots/Figure2_Exploring_eloscores_100sim_package_01poisson_final.tiff", 
     height=29.7, width=21,
     units='cm', compression="lzw", res=600)

tiff("plots/supplements/Figure2_Exploring_eloscores_100sim_package_01poisson_final.tiff", 
     height=29.7, width=21,
     units='cm', compression="lzw", res=600)
...
# a1 <- c("(a)","(b)","(c)","(d)","(e)","(f)")
# 
# tiff("plots/Figure2_Exploring_eloscores_100sim_package_03poissondominant.tiff", 
#      height=29.7, width=21,
#      units='cm', compression="lzw", res=600)
# 
# op <- par(mfrow = c(3,2),
...
#     if(i%%2!=0){
#       
#       axis(2,at=seq(-1,1,0.2),cex.axis=1.2,las=2,tck=0.015)
#       
#     } else {
#       
#       axis(2,at=seq(-1,1,0.2),cex.axis=1.2,las=2,tck=0.015,
...
#     
#     btext <- paste("\nb = ",bvalues[i])
#     text(48,-0.95,a1[i],adj = 0,cex=1.5)
#     text(30,-0.7,btext,adj = 0,cex=2)
#     
#     par(xpd=TRUE)
#     legend(0,-0.6,
#            c("a = 0","a = 5","a = 10","a = 15"),
...
# }
# 
# title(xlab = "number of interactions/individual",
